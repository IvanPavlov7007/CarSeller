...
public class ProductLifetimeService
{
    ...
    {
        // Removal from location but product still exists => likely clear owner (depends on your game rules).
        // If you consider "removed" = "in limbo"/hidden space, you'd move it instead of removing.
