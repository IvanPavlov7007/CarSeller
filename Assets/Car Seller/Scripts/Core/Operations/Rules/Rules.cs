...
{
    public static readonly CanStoreCar WarehouseCanStoreCar = new CanStoreCar();
    public static readonly CanStripCar WarehouseCanStripCar = new CanStripCar();
...
public class CanStoreCar : CarWarehouseRule
{
    public override bool Check(Car car, Warehouse warehouse)
    {
        if (car == null || warehouse == null)
...
public class CanStripCar : CarWarehouseRule
{
    public override bool Check(Car car, Warehouse warehouse)
    {
        if (car == null || warehouse == null)
